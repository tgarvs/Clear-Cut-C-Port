...
int main()
{
    ...
    while(window.isOpen()){
        ...
        if(level == 0){
            ...
            window.draw(background);
            play_game(player_one, enemy_list, platform_list, active_bullets, active_fr, window, level_start, level, gravity, bkg, background_images, shareholder_clock, health_delay_clock);
